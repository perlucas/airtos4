...
def objective(trial):    
    learning_rate = trial.suggest_loguniform("learning_rate", 6e-5, 7e-4)
    
    num_layers = trial.suggest_categorical("num_layers", [8, 10, 12])
    layer_units = trial.suggest_categorical("layer_units", [75, 100, 125])
