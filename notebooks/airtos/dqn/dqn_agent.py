...
class DuelingDQNAgent:
    ...
    def __init__(self,
        ...
        '''Create a new DuelingDQNAgent instance
        ...
        q_net = DuelingQNetwork(
            ...
            shared_advantage_layers=shared_advantage_layers,
            value_layers=value_layers,
            initializer=tf.keras.initializers.Constant(0.005))
